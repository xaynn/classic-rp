...
function toggleDriveby()
	...
	if settings.enabled and equipedWeapon == 0 then
		...
		local speed = getElementSpeed(getPedOccupiedVehicle(localPlayer), 1)
		if driver and speed > 60 then return exports.rp_library:createBox("Za szybko jedziesz, nie możesz się wychylić.") end
